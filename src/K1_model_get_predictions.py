...
def parse_arguments():
    ...
    parser.add_argument('--input', type=str, default='data/appointments_202301_to_202412.csv',
                        help='Path to input feature-engineered data CSV')
    parser.add_argument('--output', type=str, default='data/appointments_202301_to_202412_predictions.csv',
...
def main():
    ...
    try:
        ...
        # 5. Save results
        output_columns = [
            'person_id', 'gender', 'risk_tier', 'Encounter_Date', 'Next_clinical_appointment', 'adherence_predicted', 
            'next_actual_visit', 'days_diff', 'adherence_actual', 'overall_appointment_success', 'Current_WHO_HIV_Stage'
        ]
